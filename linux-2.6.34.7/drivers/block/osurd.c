 ...
 */
static void osurd_request(request_queue_t *q)
{
	struct request *req;
 ...
 */
static void osurd_full_request(request_queue_t *q)
{
	struct request *req;
	int sectors_xferred;
 ...
 */
static int osurd_make_request(request_queue_t *q, struct bio *bio)
{
	struct osurd_dev *dev = q->queuedata;
	int status;
